...
public class WeaponManager : MonoBehaviour {
    ...
    [SerializeField]
    private HandController theHandController; //손으로도 변해야하기 때문에
    [SerializeField]
    private AxeController theAxeController; //손으로도 변해야하기 때문에
    [SerializeField]
    private PickaxeController thePickaxeController; //손으로도 변해야하기 때문에
